...
class TitleState extends MusicBeatState
{
	...
	override public function create():Void
	{
		...
		exeTitleJSON = Json.parse(Paths.getTextFromFile('images/exe/title/ExeTitleData.json'));
	...
	function startIntro()
	{
		...
		Conductor.changeBPM(exeTitleJSON.bpm);
		persistentUpdate = true;

		var bg:FlxSprite = new FlxSprite(exeTitleJSON.bgx, exeTitleJSON.bgy);
		
		bg.loadGraphic(Paths.image("exe/title/menuBegin"));
		...
		logoBl = new FlxSprite(exeTitleJSON.logox, exeTitleJSON.logoy);
		logoBl.loadGraphic(Paths.image("exe/title/logo_exe"));
		...
		titleText = new FlxSprite(exeTitleJSON.startx, exeTitleJSON.starty);
		titleText.frames = Paths.getSparrowAtlas('exe/title/titleEnter');
